...
module "prod01_kakadu_converter_s3_tiff" {
  source        = "git::https://github.com/UCLALibrary/aws_terraform_s3_module.git"
  bucket_name   = "${var.prod01_kakadu_converter_s3_tiff_bucket}"
  bucket_region = "${var.prod01_kakadu_converter_s3_tiff_bucket_region}"
}

module "prod02_kakadu_converter_s3_tiff" {
  source        = "git::https://github.com/UCLALibrary/aws_terraform_s3_module.git"
  bucket_name   = "${var.prod02_kakadu_converter_s3_tiff_bucket}"
  bucket_region = "${var.prod02_kakadu_converter_s3_tiff_bucket_region}"
}

module "prod01_kakadu_converter_lambda_tiff" {
  ...
  app_name          = "${var.prod01_lambda_name}"
  ...
  app_environment_variables = "${var.prod01_kakadu_converter_environment_variables}"

  ## KakaduConverter S3 bucket notification settings
  bucket_event = "${var.kakadu_converter_bucket_event}"
  trigger_s3_bucket_id = "${module.prod01_kakadu_converter_s3_tiff.bucket_id}"
  trigger_s3_bucket_arn = "${module.prod01_kakadu_converter_s3_tiff.bucket_arn}"
}

module "prod02_kakadu_converter_lambda_tiff" {
  source = "git::https://github.com/UCLALibrary/aws_terraform_lambda_module.git"
  ...
  ## KakaduConverter lambda function specification
  app_artifact      = "${var.kakadu_converter_artifact}"
  app_name          = "${var.prod02_lambda_name}"
  app_layers        = "${var.kakadu_converter_layers}"
  app_handler       = "${var.kakadu_converter_handler}"
  app_filter_suffix = "${var.kakadu_converter_filter_suffix}"
  app_runtime       = "${var.kakadu_converter_runtime}"
  app_memory_size   = "${var.kakadu_converter_memory_size}"
  app_timeout       = "${var.kakadu_converter_timeout}"
  app_environment_variables = "${var.prod02_kakadu_converter_environment_variables}"

  ## KakaduConverter S3 bucket notification settings
  bucket_event = "${var.kakadu_converter_bucket_event}"
  trigger_s3_bucket_id = "${module.prod02_kakadu_converter_s3_tiff.bucket_id}"
  trigger_s3_bucket_arn = "${module.prod02_kakadu_converter_s3_tiff.bucket_arn}"
}
