...
module "manifeststore" {
  ...
  dockerauth_arn                = "${var.dockerauth_arn}"
  dockerhubauth_credentials_arn = "${var.dockerhubauth_credentials_arn}"
  manifeststore_processor_selection_strategy = "${var.manifeststore_processor_selection_strategy}"
  manifeststore_manual_processor_jp2         = "${var.manifeststore_manual_processor_jp2}"
  manifeststore_enable_admin                 = "${var.manifeststore_enable_admin}"
  manifeststore_admin_secret                 = "${var.manifeststore_admin_secret}"
  s3_source_basiclookup_suffix            = "${var.s3_source_basiclookup_suffix}"
  manifeststore_heapsize                     = "${var.manifeststore_heapsize}"
  manifeststore_enable_cache_server          = "${var.manifeststore_enable_cache_server}"
  manifeststore_cache_server_derivative      = "${var.manifeststore_cache_server_derivative}"
  manifeststore_cache_server_derivative_ttl  = "${var.manifeststore_cache_server_derivative_ttl}"
  manifeststore_cache_server_purge_missing   = "${var.manifeststore_cache_server_purge_missing}"
  s3_cache_access_key                     = "${var.s3_cache_access_key}"
  s3_cache_secret_key                     = "${var.s3_cache_secret_key}"
  s3_cache_bucket                         = "${var.s3_cache_bucket}"
  s3_cache_endpoint                       = "${var.s3_cache_endpoint}"
  manifeststore_source_static      = "${var.manifeststore_source_static}"
  s3_source_access_key          = "${var.s3_source_access_key}"
  s3_source_secret_key          = "${var.s3_source_secret_key}"
  s3_source_bucket              = "${var.s3_source_bucket}"
  s3_source_endpoint            = "${var.s3_source_endpoint}"
