...
resource "aws_s3_bucket" "stage-iiif_cantaloupe_source_bucket" {
  bucket = var.stage-iiif_cantaloupe_s3_source_bucket != "" ? var.stage-iiif_cantaloupe_s3_source_bucket : local.stage-iiif_cantaloupe_s3_src_bucket
  region = var.aws_region
  force_destroy = var.force_destroy_src_bucket
  acl = "private"
}
